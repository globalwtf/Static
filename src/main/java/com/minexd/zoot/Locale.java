...
public enum Locale {
    ...
    PLAYER_LOG_WHILE_FROZEN("STAFF.PLAYER_LOG"),
    ...
    PLAYER_TAG_NOT_OWNED("PLAYER_TAG.NOT_OWNED"),
    PLAYER_TAG_ALREADY_ENABLED("PLAYER_TAG.ALREADY_ENABLED"),
    PLAYER_TAG_ENABLE_ERROR("PLAYER_TAG.ENABLE_ERROR"),
    PLAYER_TAG_ENABLED("PLAYER_TAG.ENABLED"),
    PLAYER_TAG_CLEARED("PLAYER_TAG.CLEARED"),
    PLAYER_TAG_NO_ACTIVE_TAG("PLAYER_TAG.NO_ACTIVE_TAG");
