...
public class Punishment {
    ...
    public String getKickMessage() {
        ...
        if (type == PunishmentType.BAN || type == PunishmentType.IPBAN) {
            ...
            kickMessage = "&cYour account has been blacklisted from the HCStatic Network! You cannot appeal this punishment.";
        }
        else {
            kickMessage = null;
        }
