...
public enum PunishmentType {
    ...
    BLACKLIST("Blacklist", "blacklisted", "unblacklisted", true, false, new PunishmentTypeData("Blacklists", ChatColor.DARK_RED, 14)),
    BAN("Ban", "banned", "unbanned", true, true, new PunishmentTypeData("Bans", ChatColor.RED, 1)),
    IPBAN("Ban", "ip-banned", "unbanned", true, true, new PunishmentTypeData("Bans", ChatColor.DARK_AQUA, 1)),
