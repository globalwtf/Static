...
public class BanCommand {
    ...
    @Command(names = "ban", permission = "static.staff.ban", async = true)
    public static void ban(CommandSender sender, @Flag(value = "s") boolean silent, @Param(name = "player") Profile profile, @Param(name = "duration") Duration duration, @Param(name = "reason", wildcard = true) String reason) {
