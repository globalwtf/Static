...
public class UnbanCommand {
    ...
    @Command(names = "unban", permission = "static.staff.unban", async = true)
    public static void unban(CommandSender sender, @Flag(value = "s") boolean silent, @Param(name = "player") Profile profile, @Param(name = "reason", wildcard = true) String reason) {
