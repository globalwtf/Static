...
public class UnblacklistCommand {
    ...
    @Command(names = "unblacklist", permission = "static.staff.unblacklist", async = true)
    public static void unblacklist(CommandSender sender, @Flag(value = "s") boolean silent, @Param(name = "player") Profile profile, @Param(name = "reason", wildcard = true) String reason) {
