...
import com.minexd.zoot.util.menu.menus.FilterablePaginatedMenu;
...
public class PunishmentsListMenu extends FilterablePaginatedMenu<Punishment> {
    ...
    public List<PageFilter<Punishment>> generateFilters() {
        ...
        filters.add(new PageFilter<>("Type: Blaclist", (punishment -> punishment.getType() == PunishmentType.BLACKLIST)));
        filters.add(new PageFilter<>("Type: IPBan", (punishment -> punishment.getType() == PunishmentType.IPBAN)));
    ...
    private class PunishmentInfoButton extends Button {
        ...
        public String getName(Player player) {
            return "&3" + TimeUtil.dateToString(new Date(punishment.getAddedAt()), "&7");
        }
